...
export const WIDGET_CATALOG: WidgetCatalogItem[] = [
  ...
  },
  {
    ...
    emoji: '🔊',
    category: 'core',
    description: 'กำลังพัฒนา — เปิดใช้เร็วๆ นี้ (หน้าตั้งค่าเสียงปิดชั่วคราว)',
    obsHowTo: '—',
    obsSize: '—',
    obsWidth: 1,
    obsHeight: 1,
  ...
  },
  {
    ...
    description: 'Top ผู้ส่งของขวัญ (placeholder — เร็วๆ นี้เต็มรูปแบบ)',
    obsHowTo: 'มุมข้างจอ',
    obsSize: '300 × 520',
    obsWidth: 300,
    obsHeight: 520,
  ...
  },
  {
    ...
    emoji: '❤️',
    category: 'leaderboard',
    description: 'เป้าหมายไลค์ / ยอดรวม',
    obsHowTo: '—',
    obsSize: '300 × 520',
    obsWidth: 300,
    obsHeight: 520,
